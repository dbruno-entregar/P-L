...
export const defaultTariffs: Tariff[] = [
  ...meliTariffs,
  { id: 'tar-pickit-lpg', client: 'Pickit', service: 'Pickit - Ultima Milla (Lpg)', rate: 165000, pricingType: 'route', modality: 'Última milla', vehicleType: 'Camioneta', originSite: 'Lpg', requiresHelper: false, estimatedKm: 60, description: 'Pickit Última Milla - Site Lpg' },
  { id: 'tar-pickit-lsn', client: 'Pickit', service: 'Pickit - Ultima Milla (Lsn)', rate: 165000, pricingType: 'route', modality: 'Última milla', vehicleType: 'Camioneta', originSite: 'Lsn', requiresHelper: false, estimatedKm: 60, description: 'Pickit Última Milla - Site Lsn' },
  { id: 'tar-pickit-zepita', client: 'Pickit', service: 'Pickit - Ultima Milla (Zepita)', rate: 165000, pricingType: 'route', modality: 'Última milla', vehicleType: 'Camioneta', originSite: 'Zepita', requiresHelper: false, estimatedKm: 60, description: 'Pickit Última Milla - Site Zepita' },
  { id: 'tar-pickit-sameday', client: 'Pickit', service: 'Pickit - Ultima Milla (Same Day)', rate: 175000, pricingType: 'route', modality: 'Última milla', vehicleType: 'Camioneta', originSite: 'Same Day', requiresHelper: false, estimatedKm: 65, description: 'Pickit Última Milla - Same Day' },
