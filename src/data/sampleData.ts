...
export const defaultTariffs: Tariff[] = [
  ...
  { id: 'tar-1', service: 'Mercado Libre', client: 'Mercado Libre', rate: 165000, pricingType: 'route', modality: 'Última milla', vehicleType: 'Camioneta', originSite: 'Site Mercado Libre Tablada', requiresHelper: false, estimatedKm: 85, description: 'Ruta última milla / jornada completa (Hiace / Master / Boxer)' },
